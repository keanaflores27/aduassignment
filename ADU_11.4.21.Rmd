...
In the above model, we scaled the income data so that the unit of change is thousands of dollars, not a single dollar. This makes our coefficient larger by a factor of 1,000, improving our ability to interpret the data in terms of a "practical" amount of money. However, the effect is still really small. Our model predicts that a 1,000-dollar increase in income reduces the household's rent by 1 cent. The scaling does not change the statistical significance. We're not sure this model is entirely helpful either - the income effect on rent is still very small. Perhaps a non-linear transformation would fit the model better, as we explore below. 
